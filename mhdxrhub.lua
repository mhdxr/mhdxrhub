--[[ 
    FILE: fishing_mhdxrhub_v3.1.lua (MOD Auto Favorite v1.0)
...
local GUI_NAMES = {
    Main = "mhdxrhub_Fishing_UI",
    Mobile = "mhdxrhub_Mobile_Button",
    Coords = "mhdxrhub_Coords_HUD"
}
...
local Window = WindUI:CreateWindow({ Title = "mhdxrhub", Icon = "https://tr.rbxcdn.com/30DAY-AvatarHeadshot-1997B119EA4FDF91A65C3902FE79A1E2-Png/150/150/AvatarHeadshot/Webp/noFilter", Author = "by Maman", Transparent = true })
...
TabSettings:Button({
    ...
    Callback = function()
        ...
        local myScript = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/Asiyy735/Fish-It/refs/heads/main/mhdxrhub.lua"))()'
